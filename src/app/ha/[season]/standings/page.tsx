    ...
    const loadData = async () => {
      try {
        ...
        const [standingsResponse, gamesResponse] = await Promise.all([
          fetch(withSeason('/api/ha-standings', season)),
          fetch(withSeason('/api/ha-games', season)),
        ]);
    ...
    return (
      <main className="min-h-screen bg-gray-100 py-12 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <StandingsHeader
            league="ha"
            leagueName="HA Ligatabell"
            logoUrl="https://sportality.cdn.s8y.se/team-logos/ha1_ha.svg"
            backPath={leagueBasePath('ha', season)}
          />
          ...
          <Tabs
            tabs={[
                    ...
                    <div className="mb-4">
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          router.push(
                            `/ha/${season}/standings?${params.toString()}`,
                            {
                              scroll: false,
                            },
                          );
              ...
              },
              {
                id: 'trend',
                label: 'Trend',
                content: <TrendTable league="ha" games={games} />,
              },
              {
                id: 'matches',
                label: 'Matcher',
                content: <MatchesTable league="ha" games={games} />,
              },
              {
                id: 'results',
                label: 'Resultat',
                content: <GoalDistributionTable league="ha" games={games} />,
              },
              {
                id: 'upcoming',
                label: 'Kommande',
                content: <UpcomingGamesTable league="ha" games={games} />,
              },
            ]}
            defaultTab="table"
            queryParam="tab"
...
export default function HAStandingsPage() {
  const season = useSeason();
  return (
    <Suspense
      fallback={
