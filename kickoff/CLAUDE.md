...
## Project Overview
Matchday is a Next.js web application that displays football (soccer) league information: **Allsvenskan** (`allsvenskan`), **Premier League** (`pl`), **Champions League** (`cl`), and **Conference League** (`col`). It shows match schedules, standings, and player statistics.
