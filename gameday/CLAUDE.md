...
- Upstream base URLs: `KICKOFF_BASE_URL`, `FACEOFF_BASE_URL` (see `.env.example`; default `localhost:3001` / `:3002`).
...
```
src/app/
├── page.tsx                  # Kommande matcher: today + 2 days, ?visa=favoriter filter
